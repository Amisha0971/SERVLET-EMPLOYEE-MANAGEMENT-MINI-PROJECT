...
public class SearchEmployeeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	 ...
	 // Add the Back button to the top-left corner
        out.print("<a href='OurEmployeesServlet' class='back-button'><b>&#8592;Back</b></a>");
        ...
        try {
            le = new EmployeesDao().searchEmployees(searchQuery, searchBy) ;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        doGet(request, response); // Reuse the GET method for handling POST requests
    }
}
